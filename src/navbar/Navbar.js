    ...
    render() {
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <button className="navbar-toggler" type="button" data-toggle="navbar-collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
